...
**Totals:** 694 dashboard unit tests · 12 contract tests · 64 frontend
...
#### tests/service/test_alert_service.py — 15
...
#### tests/service/test_telegram_commands.py — 27
- test_parse_command
- test_status_active
...
#### tests/service/test_worker_presence.py — 13
...
- test_vanishing_from_table_is_not_offline
...
_Grand total: **857** enumerated cases/sections across the four tiers (plus the live
