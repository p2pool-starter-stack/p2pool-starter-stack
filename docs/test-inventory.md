...
**Totals:** 740 dashboard unit tests · 12 contract tests · 64 frontend
...
#### tests/service/test_alert_service.py — 38
...
#### tests/service/test_telegram_commands.py — 43
- test_parse_command
- test_status_active
...
_Grand total: **903** enumerated cases/sections across the four tiers (plus the live
