...
**Totals:** 735 dashboard unit tests · 12 contract tests · 64 frontend
...
#### tests/service/test_alert_service.py — 37
...
#### tests/service/test_egress.py — 26
...
#### tests/service/test_telegram_commands.py — 40
- test_parse_command
- test_status_active
...
_Grand total: **898** enumerated cases/sections across the four tiers (plus the live
