...
**Totals:** 723 dashboard unit tests · 12 contract tests · 64 frontend
...
#### tests/service/test_alert_service.py — 29
...
#### tests/service/test_telegram_commands.py — 37
- test_parse_command
- test_status_active
...
_Grand total: **886** enumerated cases/sections across the four tiers (plus the live
