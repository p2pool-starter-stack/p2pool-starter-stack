...
**Totals:** 439 dashboard unit tests · 12 contract tests · 26 frontend
...
| Tier | Suite | Cases |
|---|---|---|
| 1 — Unit | dashboard pytest | 439 |
| 1 — Unit | frontend (node --test) | 26 |
...
#### tests/service/test_data_service.py — 58
...
### Frontend logic (node --test) — 26 tests
...
_Grand total: **536** enumerated cases/sections across the four tiers (plus the live
