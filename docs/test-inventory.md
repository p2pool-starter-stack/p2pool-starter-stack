...
**Totals:** 868 dashboard unit tests · 12 contract tests · 68 frontend
...
| Tier | Suite | Cases |
|---|---|---|
| 1 — Unit | dashboard pytest | 868 |
| 1 — Unit | frontend (node --test) | 68 |
...
#### tests/service/test_metrics.py — 51
...
#### tests/service/test_telegram_commands.py — 68
- test_parse_command
- test_status_active
...
### Frontend logic (node --test) — 68 tests
...
_Grand total: **1044** enumerated cases/sections across the four tiers (plus the live
