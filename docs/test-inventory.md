...
**Totals:** 728 dashboard unit tests · 12 contract tests · 64 frontend
...
#### tests/service/test_alert_service.py — 32
...
#### tests/service/test_data_service.py — 88
...
#### tests/service/test_telegram_commands.py — 39
- test_parse_command
- test_status_active
...
_Grand total: **891** enumerated cases/sections across the four tiers (plus the live
