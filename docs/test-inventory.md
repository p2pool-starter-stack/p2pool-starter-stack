...
**Totals:** 634 dashboard unit tests · 12 contract tests · 64 frontend
tests · 52 `pithead` shell sections · 18 harness self-test sections ·
9 live config scenarios (17 axis values) · 9 mini-stack scenarios.
...
| 3 — Mini-stack | docker control-plane scenarios | 9 |
...
- test_healthchecks_fail_when_required_node_down
...
#### tests/service/test_egress.py — 25
...
#### tests/service/test_healthchecks.py — 22
- test_full_https_url_used_as_is
- test_full_http_url_used_as_is
- test_trailing_slash_stripped
- test_bare_uuid_joined_with_default_base
- test_bare_uuid_joined_with_selfhosted_base
- test_blank_and_none_resolve_to_empty
- test_active_requires_enabled_and_url
- test_disabled_is_a_noop
- test_enabled_without_url_warns_once
- test_healthy_ping_hits_the_url
- test_fail_signal_appends_fail
- test_fail_signal_ignored_when_disabled_for_node_down
- test_ping_over_tor_passes_socks_proxies
- test_ping_without_tor_sends_no_proxies
- test_from_config_wires_the_tor_proxy
...
### tests/integration/mini-stack/run-mini-stack.sh — 9 scenarios
...
_Grand total: **798** enumerated cases/sections across the four tiers (plus the live
