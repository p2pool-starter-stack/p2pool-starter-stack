...
**Totals:** 762 dashboard unit tests · 12 contract tests · 66 frontend
...
#### tests/service/test_alert_service.py — 44
...
#### tests/service/test_telegram_commands.py — 44
- test_parse_command
- test_status_active
...
_Grand total: **927** enumerated cases/sections across the four tiers (plus the live
