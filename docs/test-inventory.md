...
**Totals:** 864 dashboard unit tests · 12 contract tests · 70 frontend
...
| Tier | Suite | Cases |
|---|---|---|
| 1 — Unit | dashboard pytest | 864 |
| 1 — Unit | frontend (node --test) | 70 |
...
### Frontend logic (node --test) — 70 tests
...
_Grand total: **1042** enumerated cases/sections across the four tiers (plus the live
