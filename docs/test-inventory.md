...
**Totals:** 519 dashboard unit tests · 12 contract tests · 32 frontend
...
| Tier | Suite | Cases |
|---|---|---|
| 1 — Unit | dashboard pytest | 519 |
| 1 — Unit | frontend (node --test) | 32 |
...
#### tests/service/test_egress.py — 8
...
### Frontend logic (node --test) — 32 tests
...
_Grand total: **641** enumerated cases/sections across the four tiers (plus the live
