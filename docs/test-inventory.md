...
**Totals:** 744 dashboard unit tests · 12 contract tests · 64 frontend
...
#### tests/service/test_alert_service.py — 41
...
#### tests/service/test_data_service.py — 89
...
_Grand total: **907** enumerated cases/sections across the four tiers (plus the live
