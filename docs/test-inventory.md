...
**Totals:** 631 dashboard unit tests · 12 contract tests · 64 frontend
...
#### tests/service/test_healthchecks.py — 19
...
_Grand total: **794** enumerated cases/sections across the four tiers (plus the live
