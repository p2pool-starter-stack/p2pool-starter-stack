...
**Totals:** 793 dashboard unit tests · 12 contract tests · 66 frontend
...
#### tests/service/test_alert_service.py — 49
...
#### tests/service/test_telegram_commands.py — 60
- test_parse_command
- test_status_active
...
_Grand total: **958** enumerated cases/sections across the four tiers (plus the live
