...
**Totals:** 710 dashboard unit tests · 12 contract tests · 64 frontend
...
#### tests/service/test_alert_service.py — 20
...
#### tests/service/test_telegram_commands.py — 34
- test_parse_command
- test_status_active
...
_Grand total: **873** enumerated cases/sections across the four tiers (plus the live
