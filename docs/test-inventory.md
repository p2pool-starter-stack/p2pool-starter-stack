...
**Totals:** 428 dashboard unit tests · 12 contract tests · 25 frontend
...
#### tests/service/test_data_service.py — 55
...
#### tests/service/test_storage_service.py — 28
- test_get_tiers
...
_Grand total: **520** enumerated cases/sections across the four tiers (plus the live
