...
**Totals:** 810 dashboard unit tests · 12 contract tests · 67 frontend
...
#### tests/service/test_alert_service.py — 50
...
#### tests/service/test_storage_service.py — 35
- test_get_tiers
...
_Grand total: **983** enumerated cases/sections across the four tiers (plus the live
