...
**Totals:** 606 dashboard unit tests · 12 contract tests · 60 frontend
tests · 50 `pithead` shell sections · 17 harness self-test sections ·
...
| Tier | Suite | Cases |
|---|---|---|
| 1 — Unit | dashboard pytest | 606 |
| 1 — Unit | frontend (node --test) | 60 |
| 1 — Unit | `pithead` shell suite | 50 sections |
...
#### tests/collector/test_pools.py — 16
...
#### tests/service/test_data_service.py — 85
...
### `pithead` shell suite (tests/stack/run.sh) — 50 sections
...
### tests/integration/mini-stack/run-mini-stack.sh — 7 scenarios
...
_Grand total: **761** enumerated cases/sections across the four tiers (plus the live
