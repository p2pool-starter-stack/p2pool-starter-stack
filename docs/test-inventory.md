...
**Totals:** 845 dashboard unit tests · 12 contract tests · 67 frontend
...
#### tests/service/test_metrics.py — 45
...
#### tests/service/test_telegram_commands.py — 62
- test_parse_command
- test_status_active
...
### Frontend logic (node --test) — 67 tests
