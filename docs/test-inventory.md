...
**Totals:** 849 dashboard unit tests · 12 contract tests · 70 frontend
...
#### tests/service/test_alert_service.py — 57
...
#### tests/service/test_data_service.py — 90
...
#### tests/service/test_storage_service.py — 40
- test_get_tiers
...
_Grand total: **1027** enumerated cases/sections across the four tiers (plus the live
