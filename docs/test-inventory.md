...
**Totals:** 445 dashboard unit tests · 12 contract tests · 27 frontend
...
| Tier | Suite | Cases |
|---|---|---|
| 1 — Unit | dashboard pytest | 445 |
| 1 — Unit | frontend (node --test) | 27 |
...
#### tests/service/test_data_service.py — 63
...
#### tests/service/test_metrics.py — 35
...
### Frontend logic (node --test) — 27 tests
...
_Grand total: **543** enumerated cases/sections across the four tiers (plus the live
