...
**Totals:** 786 dashboard unit tests · 12 contract tests · 66 frontend
...
#### tests/service/test_telegram_commands.py — 53
- test_parse_command
- test_status_active
...
_Grand total: **951** enumerated cases/sections across the four tiers (plus the live
