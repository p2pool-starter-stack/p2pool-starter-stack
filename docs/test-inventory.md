...
**Totals:** 601 dashboard unit tests · 12 contract tests · 60 frontend
...
#### tests/service/test_data_service.py — 80
...
_Grand total: **755** enumerated cases/sections across the four tiers (plus the live
