...
**Totals:** 630 dashboard unit tests · 12 contract tests · 64 frontend
...
#### tests/service/test_healthchecks.py — 18
...
_Grand total: **793** enumerated cases/sections across the four tiers (plus the live
