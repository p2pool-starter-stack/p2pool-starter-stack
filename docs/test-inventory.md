...
**Totals:** 377 dashboard unit tests · 12 contract tests · 20 frontend
tests · 14 `pithead` shell sections · 11 harness self-test sections ·
...
_Grand total: **448** enumerated cases/sections across the four tiers (plus the live
