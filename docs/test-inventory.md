...
**Totals:** 739 dashboard unit tests · 12 contract tests · 64 frontend
...
#### tests/service/test_telegram_commands.py — 42
- test_parse_command
- test_status_active
...
- test_daily_summary_rolls_up_status
...
_Grand total: **902** enumerated cases/sections across the four tiers (plus the live
