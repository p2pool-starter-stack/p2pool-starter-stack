...
**Totals:** 918 dashboard unit tests · 12 contract tests · 78 frontend
...
#### tests/service/test_alert_service.py — 73
...
_Grand total: **1104** enumerated cases/sections across the four tiers (plus the live
