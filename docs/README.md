...
| [Hardware Requirements](hardware.md) | Minimum vs. recommended specs for the **stack host** — CPU, RAM, disk, network, OS — plus lighter-footprint options. (Worker-rig hardware lives in the [worker kit](../worker/Readme.md).) |
