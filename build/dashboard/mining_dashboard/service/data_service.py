            ...
            try:
                while True:
                    try:
                        ...
                        current_mode = self.state_manager.get_xvb_stats().get(
                            "current_mode", "P2POOL"
                        )
                ...
                # Graceful shutdown: close the Tari gRPC channel (mirrors state_manager.close)
                await tari_client.close()
