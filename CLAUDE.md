...
- [`docs/dev/repo-map.md`](docs/dev/repo-map.md) — where each subsystem lives, why, and its entry points. Re-derive the layout from here instead of re-scanning the tree every session.
